...
if __name__ == "__main__":
    ...
    charge, figure = compute_charge(
            prefix='Silicon', outdir='outdir', schema='../../schemas/qes.xsd', 
            fileout='charge.out', x0=(0., 0., 0.), e1=(1., 0., 0.), nx=50, 
            e2=(0., 1., 0.), ny=50, radius=10, dim=2, ifmagn='total', 
            plot_file='charge_plot', method='FFT', format='gnuplot', show=False)
