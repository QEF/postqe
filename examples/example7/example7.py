...
if __name__ == "__main__":
    ...
    figure = charge.plot(x0=(0, 0, 0), e1=(1, 0, 0), nx=10, dim=1, ifmagn='total',
                 plot_file='postqe1Dsphericalaveragegnuplot', method='spherical', format='gnuplot')
    figure = charge.plot(x0=(0, 0, 0), e1=(1, 0, 0), nx=10, dim=1, ifmagn='total',
                 plot_file='postqe1DFFTgnuplot', method='FFT', format='gnuplot')
    ...
    figure = charge.plot(x0 = (0., 0., 0.), e1 = (1., 0., 0.), nx = 10, e2 = (0., 1., 0.), ny=10, dim=2, ifmagn='total',
                plot_file='postqe2DFFTcontour', method='FFT', format='contour.x')
    figure = charge.plot(x0 = (0., 0., 0.), e1 = (1., 0., 0.), nx = 10, e2 = (0., 1., 0.), ny=10, dim=2, ifmagn='total',
                plot_file='postqe2DFFTplotrho', method='FFT', format='plotrho.x')
    figure = charge.plot(x0 = (0., 0., 0.), e1 = (1., 0., 0.), nx = 10, e2 = (0., 1., 0.), ny=10, dim=2, ifmagn='total',
    ...
    figure = charge.plot(x0 = (0., 0., 0.), e1 = (1., 0., 0.), nx = 10, e2 = (0., 1., 0.), ny=10, radius = 10, dim=2, ifmagn='total',
                plot_file='postqe2Dpolargnuplot', method='polar', format='gnuplot')
    figure = charge.plot(x0 = (0., 0., 0.), e1 = (1., 0., 0.), nx = 10, e2 = (0., 1., 0.), ny=10, radius = 10, dim=2, ifmagn='total',
                plot_file='postqe2Dpolarcontour', method='polar', format='contour.x')
    figure = charge.plot(x0 = (0., 0., 0.), e1 = (1., 0., 0.), nx = 10, e2 = (0., 1., 0.), ny=10, e3 = (0., 0., 1.), nz=10,
                   dim=3, ifmagn='total', plot_file='postqe3DFFTxsf', method='FFT', format='xsf')
    figure = charge.plot(x0=(0., 0., 0.), e1=(1., 0., 0.), nx=10, e2=(0., 1., 0.), ny=10, e3=(0., 0., 1.), nz=10,
                         dim=3, ifmagn='total', plot_file='postqe3DFFTcube', method='FFT', format='cube')
