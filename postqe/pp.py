...
def run(pars):
    ...
    if pars.commands == 'eos':
        ...
        compute_band_structure(pars.prefix, pars.outdir, pars.schema, pars.reference_energy, pars.emin,
        ...
        comput_dos(pars.prefix, pars.outdir, pars.schema, pars.width, window, pars.npts, pars.fileout,
        ...
        compute_potential(pars.prefix, pars.outdir, pars.schema, pars.pot_type, pars.fileout, pars.x0,
