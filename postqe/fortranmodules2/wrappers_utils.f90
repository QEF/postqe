!
! A collection of utility functions from QE or better written in Fortran
!

subroutine py_getcelldms(alat, at1, at2, at3, ibrav, celldm) 
implicit  none
